...
func (m *UI) sendMessage(content string, attachments ...message.Attachment) tea.Cmd {
	...
	ctx := context.Background()
	// Record the submitted prompt locally so history navigation always
	// recalls the most recent message even before the async DB write lands.
	m.recordPromptHistory(content)
	cmds = append(cmds, func() tea.Msg {
	...
	sections := []dialog.HelpSection{
		{
			...
			Rows: []dialog.HelpRow{
				...
				{Keys: "ctrl+o", Desc: "Open in external editor"},
		...
		},
		{
			Title: "Cursor",
			Rows: []dialog.HelpRow{
				{Keys: "fn+left", Desc: "Line start"},
				{Keys: "fn+right", Desc: "Line end"},
				{Keys: "ctrl+left", Desc: "Word back"},
				{Keys: "ctrl+right", Desc: "Word forward"},
				{Keys: "left / right", Desc: "Character back / forward"},
		...
		},
		{
			Title: "Delete",
			Rows: []dialog.HelpRow{
				{Keys: "backspace", Desc: "Delete character backward"},
				{Keys: "delete", Desc: "Delete character forward"},
				{Keys: "ctrl+backspace", Desc: "Delete word backward"},
				{Keys: "ctrl+delete", Desc: "Delete word forward"},
				{Keys: "ctrl+u", Desc: "Delete to line start"},
				{Keys: "ctrl+k", Desc: "Delete to line end"},
			},
		},
		{
			Title: "Select",
			Rows: []dialog.HelpRow{
				...
				{Keys: "shift+left / right", Desc: "Select character"},
				{Keys: "ctrl+shift+left / right", Desc: "Select word"},
				{Keys: "ctrl+shift+c", Desc: "Copy selection"},
				{Keys: "ctrl+shift+x", Desc: "Cut selection"},
				{Keys: "ctrl+shift+v", Desc: "Paste text"},
			},
		},
		{
			Title: "History",
			Rows: []dialog.HelpRow{
				{Keys: "up / down", Desc: "Previous / next prompt"},
				{Keys: "esc", Desc: "Cancel history / clear"},
			},
		},
		{
			Title: "Attachments",
			Rows: []dialog.HelpRow{
				{Keys: "ctrl+r", Desc: "Delete attachment"},
				{Keys: "ctrl+r+r", Desc: "Delete all attachments"},
			},
		},
	}
...
func (m *UI) handleSlashCommand(value string) (tea.Cmd, bool) {
	...
	default:
		// Match bare "/search" too: without this, typing the command with
		// no query falls through as an unknown command rather than
		// explaining that it is not configured yet.

...
func quickStyle(o quickStyleOpts) Styles {
	...
	s.Editor.PromptYoloLocalIconFocused = lipgloss.NewStyle().MarginRight(1).Foreground(o.onPrimary).Background(color.RGBA{0x68, 0x9D, 0x6A, 0xff}).Bold(true).SetString(" Y ")
	s.Editor.PromptYoloLocalIconBlurred = s.Editor.PromptYoloLocalIconFocused.Foreground(o.bgBase).Background(o.fgMoreSubtle)
	s.Editor.PromptYoloLocalDotsFocused = lipgloss.NewStyle().MarginRight(1).Foreground(color.RGBA{0x68, 0x9D, 0x6A, 0xff}).SetString(":::")
	s.Editor.PromptYoloLocalDotsBlurred = s.Editor.PromptYoloLocalDotsFocused.Foreground(o.fgMoreSubtle)
